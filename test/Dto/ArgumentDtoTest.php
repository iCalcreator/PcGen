...
class ArgumentDtoTest extends TestCase
{
     ...
     * @return array
     */
    public function argumentDtoTest1Provider() {
        $testData = [];
     ...
     * @param array $args
     */
    public function ArgumentDtoTest1( $case, array $args ) {
     ...
     * @return array
     */
    public function argumentDtoTest2Provider() {
        $testData = [];
     ...
     * @param array $exp
     */
    public function ArgumentDtoTest2( $case, array $xtra, array $exp ) {
